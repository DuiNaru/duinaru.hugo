...
게다가 마지막 날 인만큼, 특별강연까지 긴 하루였습니다.

## 기조강연

전날과와는 다르게 영어로 대부분이 진행되며, 일본어 자막이 지원되었습니다. AWS의 신념에 대해 말하기 시작해 다양한 서비스를 소개하고 AWS 커스텀 실리콘에 대해 이야기를 하면서 중간중간 관계회사분들의 이야기를 들을 수 있었습니다.

어제 purpose-built databases에 대해 인상깊었던 기억이 있는데, 이번에는 기조강연에서 언급하면서, 또 한번 데이터 중심으로 강조된 것도 인상깊었습니다.
...
AWS summit online의 막을 내리는 강연, 미래는 어떻게 바뀔지, 어떻게 바뀌어 나갈건지 등에 대해 관계자들이 나와서 서로 이야기를 주고받는 방식으로 진행되었습니다.
...
COVID-19로 인해, 현장에서 직접 듣거나 파트너 부스를 돌아다니며 등 오프라인 활동을 못 하게 된 점은 어쩔 수 없다고 생각되며, 다음에는 오프라인에서 볼 수 있었으면 하고 바랍니다.